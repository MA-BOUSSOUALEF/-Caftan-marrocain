...
const CollectionPage: React.FC = () => {
  ...
  const caftans = [
    ...
    },
    {
      ...
      description: "Gandoura blanche avec détails perlés délicats",
    ...
    {
      id: 5,
      name: "Blazer bleu minuit",
      style: "traditionnel",
      color: "or",
      occasion: "mariage",
      price: "À partir de 150€",
      image: "https://i.ibb.co/FqVNFcXm/caftan-6.jpg",
      description: "Blazer bleu minuit de soiree en brocart doré avec Aakads précieux",
