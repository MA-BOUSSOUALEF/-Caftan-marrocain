            ...
            <div className="animate-slide-up delay-300">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3 group">
                  ...
                  <span className="text-white/80 font-light text-sm">+33 6 65 71 77 35</span>
                </div>
                ...
                <div className="flex items-center space-x-3 group">
                  ...
                  <span className="text-white/80 font-light text-sm">Cafior-83@gmail.com@</span>
                </div>
                ...
                <div className="flex items-center space-x-3 group">
                  ...
                  <span className="text-white/80 font-light text-sm">Toulon, France</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <p className="text-white/40 text-xs font-light tracking-wide">
                © 2024 Cafior Fashion. Tous droits réservés.
              </p>
